...
//Space agencies
ag: {name:"Agency"},
nasa: {name:"NASA:National Aeronautics and Space Administration", desc:"url:www.nasa.gov/;ctry:us;_x:120;_y:72"},
usaf: {name:"USAF:United States Air Force", desc:"url:www.af.mil/publicwebsites/sitecmd.asp?id=5;ctry:us;x:216;y:72"},
usa: {name:"USA:United States Army", desc:"url:www.army.mil/info/organization/unitsandcommands/commandstructure/smdc/;ctry:us;x:120;y:96"},
...
noaa: {name:"NOAA:National Oceanic and Atmospheric Administration", desc:"url:www.noaa.gov/;x:144;y:72"},
b612: {name:"B612:B612 Foundation", desc:"url:b612foundation.org;x:192;y:0"},
glxp: {name:"GLXP:Google Lunar X-Prize", desc:"url:www.googlelunarxprize.org/"},

rosc: {name:"Roscosmos:Russian State Corporation", desc:"url:en.federalspace.ru;ctry:ru;x:168;y:72"},
rsf: {name:"Russian Space Forces", desc:"ctry:ru;x:192;y:72"},
okb: {name:"OKB-1:Experimental Design Bureau No. 1", desc:"url:www.energia.ru/english/index.html;ctry:su"},
lav: {name:"NPO Lavochkin:Lavochkin Scientific Production Association", desc:"url:www.laspace.ru/rus/index.php;ctry:su,ru;x:216;y:48"},
...
iki: {name:"IKI:Space Research Institute", desc:"url:www.iki.rssi.ru/eng/index.htm;ctry:su,ru;x:216;y:24"},

esa: {name:"ESA:European Space Agency", desc:"url:www.esa.int/esaCP/index.html;ctry:eu;x:168;y:24"},
dfvlr: {name:"DFVLR:Deutsche Forschungs- und Versuchsanstalt für Luft- und Raumfahrt", desc:"url:www.dlr.de/dlr/en/desktopdefault.aspx/tabid-10002/;x:120;y:24"},
dlr: {name:"DLR:Deutsches Zentrum für Luft- und Raumfahrt", desc:"url:www.dlr.de/dlr/en/desktopdefault.aspx/tabid-10002/;x:120;y:24"},
cnes: {name:"CNES:Centre national d'études spatiales", desc:"url:www.cnes.fr/web/455-cnes-en.php;x:216;y:120"},
asi: {name:"ASI:Agenzia Spaziale Italiana", desc:"url:www.asi.it/en;x:168;y:0"},

isas: {name:"ISAS:Institute of Space and Astronautical Science (JAXA)", desc:"url:www.isas.jaxa.jp/e/index.shtml;ctry:jp;x:120;y:48"},
jaxa: {name:"JAXA:Japan Aerospace Exploration Agency", desc:"url:www.jaxa.jp/index_e.html;ctry:jp;x:168;y:48"},
...
cnsa: {name:"CNSA:China National Space Administration", desc:"url:www.cnsa.gov.cn/n615709/cindex-linshi.html;ctry:cn;x:216;y:0"},
clep: {name:"CLEP:Chinese Lunar Exploration Program"},

kari: {name:"KARI:Korea Aerospace Research Institute", desc:"url:http://www.kari.re.kr/eng.do;ctry:sk;x:192;y:144"},
clep: {name:"KLEP:Korean Lunar Exploration Program"},

stp: {name:"STP:Solar Terrestrial Probes"},
exom: {name:"ExoMars:Exobiology on Mars"},
isro: {name:"ISRO:Indian Space Research Organisation", desc:"url:www.isro.org/index.aspx;ctry:ind;x:144;y:48"},
...
msss: {name:"MSSS:Malin Space Science Systems", desc:"url:www.msss.com/;x:120;y:120"},
rsw:  {name:"Russian Spaceweb", desc:"url:www.russianspaceweb.com/;x:144;y:120"},
...
tps: {name:"Planetary Society", desc:"url:www.planetary.org/;x:168;y:120"},
...
usgs: {name:"USGS:U.S. Geological Survey Astrogeology Science Center", desc:"url:astrogeology.usgs.gov/;x:192;y:120"},
raw: {name:"Images"},
