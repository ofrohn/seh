...
var diag='<!DOCTYPE html><html><head><title>History of Solar System Exploration %ver%</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link rel="stylesheet" media="screen" href="style-%ver%.css" type="text/css"><script type="text/javascript" src="data-%ver%.js"></script><script type="text/javascript" src="app-%ver%.js"></script><script type="text/javascript">function init() {var img, param, height; param=Hist.init(); height=window.innerHeight; if (!param.c) { img=new Image(); img.src="hist.png"; img.style.width=px(param.w); img.style.height="auto"; img.style.position="absolute"; img.style.top=px(0); param.p.appendChild(img); } else {  setTimeout(Hist.load, 100); } }</script></head><body onload="init()"><noscript> Please enable javascript in your browser.</noscript></body></html>'.replace(/%ver%/g, version);

fs.writeFileSync('./pub/diag-' + version + '.html', diag);
