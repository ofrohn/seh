...
cheops:{name:"CHEOPS:CHaracterising ExOPlanets Satellite", url:"hp:cheops.unibe.ch/;esa:sci.esa.int/cheops/", desc:"ag:esa;fam:S-class;lv:Soyuz STB/Fregat-MT;m:250kg;sc:0.7;x:0;y:0", stat:"pl", 
  parts: [
    ...
    {pt:"", dt:"2018-12", tp:"l", loc:"ter:kou:ELS", desc:""},
...
jwst:{name:"JWST:James Webb Space Telescope", url:"hp:www.jwst.nasa.gov/;stsci:www.stsci.edu/jwst/;esa:www.esa.int/Our_activities/Space_Science/JWST;tw:twitter.com/JWSTObserver", desc:"lv:Ariane 5 ECA;sc:1.8;x:12;y:-8", stat:"pl", 
  parts: [
    ...
    {pt:"", dt:"2020-05", tp:"l", loc:"ter:kou:ELA-3", desc:"kou"},
    {pt:"", dt:"l+30d", tp:"sco", loc:"sol:esl2", desc:""}
  ], inst: [
...
xuntian:{name:"Xuntian:Sky Survey", url:"hp:", desc:"ag:cnsa;lv:CZ-5B;sc:0.9;y:7", stat:"pl", 
  parts: [
    ...
    {n:"OS", type:"is", band:"255..1000nm", res:"0.15", px:0.07, d:2, fov:"1.1deg2", desc:"c:nr;cl:nl"}
  ]},
